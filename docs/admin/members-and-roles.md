...
For authentication options (password, Microsoft Entra ID SSO, trusted headers), see [Authentication](/admin/authentication).
...
For full setup instructions, see the [Authentication guide](/admin/authentication).
