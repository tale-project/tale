...
This page covers day-to-day provider management in the admin UI. For connecting self-hosted models (Ollama, vLLM, LocalAI, etc.), see [Bring your own model](/build/integrations/providers).
...
You can also edit these files directly instead of using the UI. See [environment reference](/operate/configuration/environment-reference) for the `TALE_CONFIG_DIR` location.
