...
See the [environment reference](/operate/configuration/environment-reference) for all available options.
...
If v0.2.x misbehaves and you need to return to v0.2.x, **do not delete
...
Reports are saved to the `trivy-reports/` directory. See the [container architecture](/operate/deployment/container-architecture) page for image details.
