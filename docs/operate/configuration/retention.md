...
- **Governance UI** — per-organisation overrides within the environment floor. See [Governance](/admin/governance).
...
- [Environment reference](/operate/configuration/environment-reference) — full list of Tale environment variables.
- [Governance](/admin/governance) — per-org retention overrides and legal hold.
