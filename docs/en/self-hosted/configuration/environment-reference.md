...
| `VIDEO_INGEST_YTDLP_PLUGIN_DIRS` | `/opt/yt-dlp/plugins` (baked)         | Directory yt-dlp loads plugins from. Defaults to the baked-in bgutil plugin dir when present; override only to add your own plugins.                                                                                                      |
