...
description: An agent built end to end on camera — name, instructions, knowledge scope, tools, model — then made visible and tested live, with the trust boundary spelled out.
---
