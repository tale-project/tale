...
The knobs that used to sit on an agent editor live elsewhere in this version: knowledge is organization-wide under [Knowledge](/platform/knowledge/overview) and reached through platform tools ([Agent knowledge](/platform/agents/knowledge) explains how), and work that should run without a person is an [automation](/platform/automations/concepts) rather than a second agent.
