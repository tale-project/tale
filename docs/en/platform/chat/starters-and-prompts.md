...
Agent authors maintain starters on the agent's instructions page; see [Conversation starters](/platform/agents/conversation-starters) for the author side. Members see what the author published; there is no per-user override.
