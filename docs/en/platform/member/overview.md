...
The org configuration settings — providers, integrations, agents, governance — are hidden for Members; the work surface is the bulk of what is left. The exception is a small personal settings group every role carries: Account, Personalization, and [Environment & secrets](/platform/member/environment), the keys and variables injected into the sandboxes you run.
