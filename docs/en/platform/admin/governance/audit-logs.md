---
title: Audit logs
description: The chronological log of who-did-what across your organisation — sign-ins, role changes, provider edits, agent edits. Admins and Owners read this when an audit asks who touched a resource and when.
---
