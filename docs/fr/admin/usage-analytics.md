...
Les données analytiques suivent la [politique de rétention](/fr/admin/governance) générale. Par défaut, les enregistrements détaillés sont gardés 13 mois pour permettre des comparaisons année/année ; les totaux mensuels agrégés restent indéfiniment.

## Lié

- [Gouvernance](/fr/admin/governance) — régler les budgets et limites affichés ici.
- [Operations](/fr/operate/observability/operations) — observabilité côté opérateur (Prometheus, logs, health).
