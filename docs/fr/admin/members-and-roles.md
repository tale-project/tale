...
Pour les options d'authentification (mot de passe, SSO Microsoft Entra ID, Trusted Headers), voir [Authentification](/fr/admin/authentication).
...
Pour l'installation complète, voir le [guide d'authentification](/fr/admin/authentication).
