...
- **Nombre maximal par message :** 10. Pour l'ingestion en masse, utilise la [base de connaissances](/fr/use/workspace/knowledge-base).
...
Supprimer une conversation supprime aussi ses pièces jointes, sauf si la [politique de rétention](/fr/admin/governance) de ton organisation les conserve plus longtemps.

## Sécurité

Les téléversements sont scannés pour virus et types MIME bloqués avant d'atteindre le modèle. Si ton admin a activé la [détection DCP](/fr/admin/governance), les textes extraits des pièces jointes passent par les mêmes règles que les messages saisis.
