...
Canvas est un panneau latéral à côté du chat, un espace de travail concentré pour voir et éditer le contenu généré par l'IA. Au lieu de faire défiler les blocs de code dans la conversation, tu les ouvres dans Canvas pour coloration syntaxique, aperçu en direct, édition et export.

## Ouvrir Canvas

Quand l'IA génère un bloc de code, un snippet HTML, un diagramme Mermaid ou un bloc Markdown, un bouton **Open in Canvas** apparaît sur le bloc. Clique-le pour ouvrir le contenu dans le panneau Canvas à droite.
