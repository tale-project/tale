...
description: Partager un chat avec le reste de l’organisation — le lien de partage en un seul geste, l’instantané en lecture seule que voit le destinataire, et comment arrêter le partage.
---
...
Ouvre le chat et clique sur le menu **⋯** dans l’en-tête, puis sur **Partager**. Le lien atterrit aussitôt dans ton presse-papiers — un toast **Lien copié** le confirme. La même entrée figure aussi dans le menu de la ligne de chaque chat, dans la barre latérale.
...
- **C’est un instantané.** Le destinataire voit la conversation telle qu’elle était au moment du partage. Si le chat a avancé et que tu veux partager l’état plus récent, clique de nouveau sur **Partager** — le lien reste le même et l’instantané se rafraîchit.
