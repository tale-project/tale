...
Les données analytiques suivent la [politique de rétention](/fr/platform/admin/governance) générale. Par défaut, les enregistrements détaillés sont gardés 13 mois pour permettre des comparaisons année/année ; les totaux mensuels agrégés restent indéfiniment.
