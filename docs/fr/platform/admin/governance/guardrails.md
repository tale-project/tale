...
![La page de gouvernance Garde-fous montrant trois cartes de statut pour la sécurité du contenu, la détection PII et le fournisseur de modération — toutes désactivées — au-dessus d’un tableau vide des événements récents.](/images/platform/governance-guardrails.webp)
