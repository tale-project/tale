...
- **Courriel et mot de passe.** Ton Admin crée ton compte depuis **Paramètres → Membres** avec un mot de passe initial et te le transmet. Tu seras obligé·e de le changer à la première connexion.
