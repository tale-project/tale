...
Tale comprend six rôles. Quatre d’entre eux disposent ici d’un guide orienté tâches ; Owner correspond à Admin plus quelques actions de cycle de vie ; Disabled n’a pas d’accès au produit.

- **[Member](/fr/platform/member/overview)** — lecture seule : utiliser le chat, parcourir les connaissances, consulter les conversations et les approbations.
- **[Editor](/fr/platform/editor/overview)** — Member plus gestion de contenu et décisions d’approbation.
- **[Developer](/fr/platform/developer/overview)** — Editor plus agents, automatisations, intégrations et clés API.
- **[Admin](/fr/platform/admin/overview)** — Developer plus paramètres d’organisation.
