...
La Bibliothèque de prompts est une collection partagée de modèles de prompt réutilisables. Enregistre les prompts que tu utilises souvent, organise-les par catégorie et tags, et partage avec ton équipe ou toute l'organisation.

## Parcourir les prompts

Ouvre la Bibliothèque de prompts depuis la barre d'outils du chat. Le dialogue affiche tous les prompts auxquels tu as accès dans une grille cherchable.
