...
> **Note :** Modifier la base de connaissances demande le rôle Éditeur ou plus. Les membres en lecture seule voient tous les éléments mais ne peuvent pas créer, mettre à jour ou supprimer.
...
Voir [Comparaison de documents](/fr/platform/workspace/document-comparison) pour tous les détails.
