...
Les tutoriels sont groupés par rôle, pour que tu atterrisses sur du contenu que tu peux vraiment exécuter. Les permissions suivent le [modèle à six rôles](/fr/platform/admin/members-and-roles) ; si un tutoriel est sous Admin, il te faut un siège Admin ou Propriétaire pour le terminer.
