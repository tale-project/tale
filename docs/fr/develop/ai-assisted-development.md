...
| `default/connectors/`, `default/providers/`, `default/workflows/` | Vides après un init frais — les fichiers de connector, de fournisseur et de workflow que tu ajoutes atterrissent ici.                                                               |
