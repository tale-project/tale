...
- **Security** : tout ce qui touche à l'authentification, session, stockage de secrets, crypto ou CVE de dépendance atteignable. Dans le doute, classer en security ET ouvrir un [Security Advisory](/fr/operate/security/advisories).
...
- [Processus de Security Advisory](/fr/operate/security/advisories) — quand ouvrir aussi un GitHub Security Advisory.
