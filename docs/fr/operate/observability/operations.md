...
Si une image dépasse son budget après changement, `bun run docker:test:image` échoue. Voir la page [Architecture des conteneurs](/fr/operate/deployment/container-architecture) pour les stratégies multi-stage qui gardent les images légères.
