...
- **Interface de gouvernance** — surcharges par organisation dans la limite environnement. Voir [Gouvernance](/fr/admin/governance).
...
- [Référence d'environnement](/fr/operate/configuration/environment-reference) — liste complète des variables d'environnement Tale.
- [Gouvernance](/fr/admin/governance) — surcharges de rétention par organisation et legal hold.
