...
Pour utiliser une instance PostgreSQL externe au lieu du conteneur fourni, voir [Utiliser une base externe](/fr/operate/deployment/production#utiliser-une-base-externe).
...
Non défini, les endpoints `/metrics/*` renvoient `401`. Voir [Operations](/fr/operate/observability/operations) pour les détails.
...
Voir le [guide d'authentification](/fr/admin/authentication) pour configurer les Trusted Headers.
