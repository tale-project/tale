...
Voir [Déploiement en production → Compatibilité de schéma et rollback](/fr/self-hosted/install/linux-server#compatibilité-de-schéma-et-rollback) pour la gestion des changements de schéma entre versions.
