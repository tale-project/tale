...
Voir [Déploiement en production → Compatibilité de schéma et rollback](/fr/self-hosted/install/linux-server#compatibilite-de-schema-et-rollback) pour la gestion des changements de schéma entre versions.
