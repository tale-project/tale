...
Ces valeurs déterminent le nombre de réplicas par rôle applicatif dans un déploiement de workspace. `tale deploy` les lit dans l’environnement du projet et ramène les valeurs hors limites dans la plage autorisée avec un avertissement.
