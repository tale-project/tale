...
| `INSTANCE_SECRET`       | valeur d'exemple dans le fichier | **Obligatoire.** Sert à dériver la clé admin de déploiement et la clé HMAC des mots de passe d'app WebDAV. Le déploiement échoue si non défini. Garde-la stable entre les déploiements.                                                                                                     |
