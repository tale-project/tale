...
| Nom                    | Défaut | Description                                                                                                                           |
| ---------------------- | ------ | ------------------------------------------------------------------------------------------------------------------------------------- |
| `SLACK_CLIENT_ID`      | unset  | Client ID OAuth de l'app Slack partagée. Injecté sur le credential de chaque org à la connexion, les admins ne le collent jamais.     |
| `SLACK_CLIENT_SECRET`  | unset  | Client secret OAuth de l'app Slack partagée. Chiffré avant stockage.                                                                  |
| `SLACK_SIGNING_SECRET` | unset  | Secret pour vérifier les requêtes d'événements Slack entrantes (HMAC sur le corps brut). Requis pour que le bot reçoive des messages. |
