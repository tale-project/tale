...
| Nom                               | Défaut                   | Description                                                                                                                                                                                                                                                |
| --------------------------------- | ------------------------ | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `TRUSTED_SECRET_HEADER` | `Remote-Internal-Secret` | Nom de l'en-tête de requête qui peut porter la clé trusted headers de l'organisation lorsque le proxy ne peut pas l'envoyer comme jeton bearer `Authorization`. |
