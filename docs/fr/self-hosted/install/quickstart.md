...
- **[Docker Desktop](https://www.docker.com/products/docker-desktop)** (v24+) en marche, ou Docker Engine plus le plugin Compose sous Linux. C'est le seul prérequis pour faire monter la stack.
