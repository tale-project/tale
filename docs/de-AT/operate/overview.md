...
- KI-Chat-Assistent mit mehrstufigen Konversationen, Datei-Anhängen, Agent-Auswahl, [Arena Mode](/de-AT/use/chat/arena-mode) zum Modellvergleich, [Canvas](/de-AT/use/workspace/canvas) zur Inhaltsbearbeitung und eingebauten Tools.
- [Prompt Library](/de-AT/use/workspace/prompt-library) zum Speichern und Teilen wiederverwendbarer Prompt-Vorlagen.
- Semantische Wissensdatenbank für Dokumente, Websites, Products, Customers und Vendors mit [Dokumenten-Vergleich](/de-AT/use/workspace/document-comparison).
