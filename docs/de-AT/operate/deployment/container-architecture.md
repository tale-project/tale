...
| `convex-data`   | Crawler, RAG                  | `/app/platform-config` **(read-only)** | gemeinsamer Provider-Config                                                                                                                 |
...
Siehe [Contributing Docker guide](/de-AT/develop/contributing-docker) für Details zum Ändern von Dockerfiles und Ausführen der Tests.
