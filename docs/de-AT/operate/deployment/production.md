...
Alle verfügbaren Optionen in der [Environment-Referenz](/de-AT/operate/configuration/environment-reference).
...
Berichte landen im Verzeichnis `trivy-reports/`. Siehe [Container-Architektur](/de-AT/operate/deployment/container-architecture) für Image-Details.
