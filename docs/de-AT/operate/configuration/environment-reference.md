...
Zum Einsatz einer externen PostgreSQL-Instanz statt des mitgelieferten Containers siehe [Externe Datenbank nutzen](/de-AT/operate/deployment/production#externe-datenbank-nutzen).
...
Wenn leer, liefern alle `/metrics/*`-Endpoints `401`. Siehe [Operations](/de-AT/operate/observability/operations) für Endpoint-Details.
...
Siehe die [Authentifizierungs-Anleitung](/de-AT/admin/authentication) für Details zur Konfiguration von Trusted Headers.
