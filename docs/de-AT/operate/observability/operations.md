...
Überschreitet ein Image nach einer Änderung sein Budget, schlägt `bun run docker:test:image` fehl. Siehe die Seite [Container-Architektur](/de-AT/operate/deployment/container-architecture) für Multi-Stage-Strategien, die Images klein halten.
