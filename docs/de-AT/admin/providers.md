...
Diese Seite beschreibt das tägliche Anbieter-Management im Admin-UI. Für das Anbinden selbst gehosteter Modelle (Ollama, vLLM, LocalAI, etc.) siehe [Eigene Modelle anbinden](/de-AT/build/integrations/providers).
...
Du kannst die Dateien auch direkt bearbeiten, statt die UI zu nutzen. Siehe [Environment-Referenz](/de-AT/operate/configuration/environment-reference) für den Ort von `TALE_CONFIG_DIR`.
