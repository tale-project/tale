...
Analytics-Daten folgen der allgemeinen [Retention-Richtlinie](/de-AT/admin/governance). Standardmäßig werden detaillierte Usage-Datensätze 13 Monate lang aufbewahrt, sodass du Jahr-über-Jahr-Vergleiche hast; aggregierte Monatswerte bleiben unbegrenzt.

## Verwandt

- [Governance](/de-AT/admin/governance) — die hier gezeigten Budgets und Limits konfigurieren.
- [Operations](/de-AT/operate/observability/operations) — Operator-seitige Observability (Prometheus, Logs, Health).
