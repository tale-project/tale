...
- **Maximale Dateien pro Nachricht:** 10. Für Massen-Imports nutze stattdessen die [Wissensdatenbank](/de-AT/use/workspace/knowledge-base).
...
Das Löschen einer Konversation löscht auch ihre Anhänge, sofern deine Organisations-[Retention-Richtlinie](/de-AT/admin/governance) sie nicht länger aufbewahrt.

## Sicherheit

Uploads werden vor dem Eintreffen beim Modell auf Viren und blockierte MIME-Typen geprüft. Wenn dein Admin [PII-Erkennung](/de-AT/admin/governance) aktiviert hat, werden aus Anhängen extrahierte Texte denselben Regeln unterworfen wie getippte Nachrichten.
