...
L'Arena Mode te laisse envoyer le même message à deux modèles IA à la fois et comparer leurs réponses dans une vue divisée. Utilise-le pour évaluer la qualité des modèles, tester un nouveau modèle face à ton défaut actuel ou collecter des données de préférence dans ton équipe.

## Activer l'Arena Mode
