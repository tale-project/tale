...
Voir [Comparaison de documents](/fr-CH/use/workspace/document-comparison) pour tous les détails.
...
Pour plus de contrôle sur le crawling, voir [Crawling de sites](/fr-CH/build/knowledge/crawling).
