...
| **Budgets et accès modèle** | les politiques de gouvernance (voir [Governance](/fr-CH/admin/governance)) peuvent être cadrées par équipe.                                                            |
...
Quand SSO ou Trusted Headers sont utilisés, l'IdP externe est la source unique de vérité pour l'appartenance aux équipes. Tale lit le header des équipes à chaque connexion et met à jour la liste des équipes de l'utilisateur. Voir [Authentification](/fr-CH/admin/authentication).
