...
- Chat IA avec conversations multi-tours, pièces jointes, sélection d'agent, [arena mode](/fr-CH/use/chat/arena-mode) pour comparer des modèles, [canvas](/fr-CH/use/workspace/canvas) pour éditer du contenu et outils intégrés.
- [Prompt library](/fr-CH/use/workspace/prompt-library) pour enregistrer et partager des modèles de prompt.
- Base de connaissances sémantique pour documents, sites, Products, Customers, Vendors avec [comparaison de documents](/fr-CH/use/workspace/document-comparison).
