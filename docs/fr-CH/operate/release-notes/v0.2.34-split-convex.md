...
Voir [Déploiement en production → Compatibilité de schéma et rollback](/fr-CH/operate/deployment/production#compatibilite-de-schema-et-rollback) pour la gestion des changements de schéma entre versions.
