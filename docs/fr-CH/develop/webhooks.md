...
- [Référence API](/fr-CH/develop/api-reference) pour l'API REST complète.
- [Triggers](/fr-CH/build/automations/triggers) pour configurer des triggers webhook sur les workflows.
- [Agents — onglet Webhook](/fr-CH/build/agents/create#onglet-webhook) pour la mise en place des webhooks d'agent.
