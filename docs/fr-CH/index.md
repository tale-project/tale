...
**[Utiliser Tale](/fr-CH/use/getting-started)** — discute avec l'IA, parcours ta base de connaissances, collabore dans le canvas et traite les approbations.

_Si tu utilises Tale chaque jour pour avancer dans ton travail, commence ici._

### Pour les constructeurs

**[Configurer Tale](/fr-CH/build/overview)** — crée des agents personnalisés, conçois des automatisations multi-étapes, gère les intégrations et cure les connaissances structurées.
...
**[Administrer Tale](/fr-CH/admin/members-and-roles)** — gère les members et les rôles, configure les fournisseurs IA et le SSO, applique les politiques de gouvernance et consulte les audit-logs.

_Si tu possèdes les paramètres et les politiques au niveau de l'organisation, va ici._

### Pour les opérateurs

**[Exploiter Tale](/fr-CH/operate/overview)** — déploie, surveille, mets à l'échelle et dépanne une instance Tale auto-hébergée.
...
**[Développer avec Tale](/fr-CH/develop/api-reference)** — appelle l'API REST, traite les webhooks et contribue à la plateforme.
