...
This is the fastest way to go from nothing to a running Tale instance. You don't need to be a developer — if you can run a command in a terminal, you can follow along. For self-hosted production setups, see [Production deployment](/operate/deployment/production) instead.
