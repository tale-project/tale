...
The knowledge base is where Tale stores information for the AI to use. Anything you add here becomes searchable by the chat agent using meaning-based search. This page covers the two user-facing sections — **Documents** and **Websites**. For structured-data sections (Products, Customers, Vendors), see [Structured data](/build/knowledge/structured-data).
...
See [Document comparison](/use/workspace/document-comparison) for full details.
...
For deeper control over crawling behaviour, see [Website crawling](/build/knowledge/crawling).
