...
- **[selbst gehostet](/de/self-hosted)** — du betreibst das Docker-Compose-Bundle in deinem VPC, auf eigener Hardware oder in einer Air-Gap-Umgebung. Passend, wenn Datensouveränität, eigene Netzwerkkonzepte oder ein eigener Build gefordert sind.
...
- **Deine Daten bleiben in deiner Region.** Cloud weist jeden Tenant fest der Schweiz oder der EU zu und legt alle Subprocessor:innen offen. selbst gehostet verlässt das Netzwerk überhaupt nicht — weder Prompts noch Dokumentinhalte.
