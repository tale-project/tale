...
Ein Agent ist ein Bündel aus vier Dingen: **Anweisungen** (wie er sich verhält), **Wissen** (was er lesen darf), **Tools** (was er tun darf) und einem **Modell** (wie er denkt). Alles andere — Versionierung, Webhooks, Conversation Starter — sind Infrastruktur rund um diese vier.
...
Wissen ist die Teilmenge der [Wissensdatenbank](/de/platform/workspace/knowledge-base), die der Agent durchsuchen darf. Standardmäßig dürfen Agents alles durchsuchen, was die Organisation hochgeladen hat. Du kannst das nach Ordner, Team oder Entitätstyp (Dokumente, Products, Customers, Vendors) einschränken.
...
Jeder Agent ist an ein Modell-Preset gebunden — **Fast**, **Standard** oder **Advanced**. Jedes Preset ist einem bestimmten KI-Modell aus deinen [Anbietern](/de/platform/admin/providers) zugeordnet. Fast ist am günstigsten und schnellsten; Advanced ist am leistungsfähigsten.
...
| -------------------- | --------------------------------------------- | ------------------------------------ | ------------------------------ | -------- |
| Freundlicher Support | hilfsbereit, knapp, lehnt Off-Scope-Fragen ab | nur Help-Center-Dokumente            | Wissens-Suche, Customer-Lookup | Standard |
| Sales Research       | gründlich, zitiert Quellen                    | alle Dokumente + Websites + Products | Wissens-Suche, Web-Suche       | Advanced |
| Daten-Exploration    | vorsichtig, erklärt Abfragen                  | alle SQL-Verbindungen                | SQL-Integration, Wissens-Suche | Fast     |
