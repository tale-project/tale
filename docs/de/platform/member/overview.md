...
<Card title="Eine hilfreiche Frage stellen" icon="message-circle" href="/de/tutorials/member/chat-effectively">

Übe mit einer Quelle, prüfe die Fakten und frage gezielt nach.

</Card>

<Card title="Gemeinsames Wissen lesen" icon="library" href="/de/platform/knowledge/overview">

Finde Dokumente, Informationen und Datensätze und verstehe fehlenden Zugriff.

</Card>

<Card title="Projekte verstehen" icon="folder-open" href="/de/platform/projects/concepts">

Erfahre, welche Dateien und Gespräche zu einem Projekt gehören und welche Chats persönlich bleiben.
