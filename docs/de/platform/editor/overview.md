...
<Card title="Wissen pflegen" icon="library" href="/de/platform/knowledge/overview">

Wähle Dateien, kurze Informationen, Websites oder strukturierte Datensätze.

</Card>

<Card title="Ein Projekt einrichten" icon="folder-open" href="/de/tutorials/member/use-projects">

Halte Dateien und Anweisungen zusammen und frage im Projektchat nach.

</Card>

<Card title="Arbeit als Aufgaben verfolgen" icon="list-checks" href="/de/platform/projects/tasks">

Dokumentiere Abnahmekriterien, Zuständigkeit, Fortschritt und Prüfung.

</Card>

<Card title="Wiederverwendbare Anweisungen pflegen" icon="list-plus" href="/de/platform/workspace/skills">

Erstelle und teile Skills für Agenten, die eine wiederholbare Methode brauchen.
