...
Alle verfügbaren Optionen in der [Environment-Referenz](/de/operate/configuration/environment-reference).
...
Berichte landen im Verzeichnis `trivy-reports/`. Siehe [Container-Architektur](/de/operate/deployment/container-architecture) für Image-Details.
