...
- KI-Chat-Assistent mit mehrstufigen Konversationen, Datei-Anhängen, Agent-Auswahl, [Arena Mode](/de/use/chat/arena-mode) zum Modellvergleich, [Canvas](/de/use/workspace/canvas) zur Inhaltsbearbeitung und eingebauten Tools.
- [Prompt Library](/de/use/workspace/prompt-library) zum Speichern und Teilen wiederverwendbarer Prompt-Vorlagen.
- Semantische Wissensdatenbank für Dokumente, Websites, Products, Customers und Vendors mit [Dokumenten-Vergleich](/de/use/workspace/document-comparison).
