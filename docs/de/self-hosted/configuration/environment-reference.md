...
| Name                              | Default                  | Beschreibung                                                                                                                                                                                                                                 |
| --------------------------------- | ------------------------ | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `TRUSTED_SECRET_HEADER` | `Remote-Internal-Secret` | Name des Request-Headers, der den Trusted-Header-Schlüssel der Organisation tragen darf, wenn der Proxy ihn nicht als `Authorization`-Bearer-Token senden kann. |
