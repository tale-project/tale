...
Der Lokaler-Anbieter-Pfad passt sauber zu zwei anderen Integrationen-Tutorials: [Meeting-Transkription](/de/tutorials/admin/meeting-transcription) hält den Audio-Pfad auf dem Gerät, während das Zusammenfassungs-LLM lokal bleibt, und [Word- & Excel-Add-in](/de/tutorials/admin/office-add-in) routet Office-Verkehr durch Tale zu welchem Anbieter auch immer du konfiguriert hast.
