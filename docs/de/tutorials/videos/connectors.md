...
Der MCP-Abschnitt (1:09–1:45) wurde im Panel **MCP-Server** der früheren Version aufgenommen. Einen externen Server zu registrieren und seine Freigabe-Flags pro Werkzeug gibt es in dieser Version nicht — Tales einzige MCP-Oberfläche ist der eingehende Endpoint unter **Einstellungen > API > MCP**, an dem dein Client Tale steuert. Sieh ihn dir für das Muster an jeder Tür an; [MCP-Server](/de/platform/connectors/mcp-servers) sagt, was an die Stelle des Panels getreten ist.
