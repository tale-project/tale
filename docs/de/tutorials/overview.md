...
- **Member** — [Effektiv chatten](/de/tutorials/member/chat-effectively): Agents, Anhänge und Diktat zu einem täglichen Workflow kombinieren.
- **Editor** — [Den ersten Agent end-to-end bauen](/de/tutorials/editor/first-agent-end-to-end): Agent anlegen, Wissen anhängen, testen und eine Version veröffentlichen.
- **Developer** — [Tale aus einem Skript aufrufen](/de/tutorials/developer/call-tale-from-a-script) und [Eine Automatisierung per Webhook auslösen](/de/tutorials/developer/trigger-automation-via-webhook).
