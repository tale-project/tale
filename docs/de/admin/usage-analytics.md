...
Analytics-Daten folgen der allgemeinen [Retention-Richtlinie](/de/admin/governance). Standardmäßig werden detaillierte Usage-Datensätze 13 Monate lang aufbewahrt, sodass du Jahr-über-Jahr-Vergleiche hast; aggregierte Monatswerte bleiben unbegrenzt.

## Verwandt

- [Governance](/de/admin/governance) — die hier gezeigten Budgets und Limits konfigurieren.
- [Operations](/de/operate/observability/operations) — Operator-seitige Observability (Prometheus, Logs, Health).
