...
- Betroffenenrechte: Löschung (Art. 17 per Cascade bei Member-Entfernung und Org-Löschung). Ein vom Betreiber ausführbarer Export (Art. 15/20) steht gegen die zugrunde liegenden Tabellen zur Verfügung; produktinterner Self-Service-Export ist für v2 geplant.
