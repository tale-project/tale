...
- **OpenRouter** verarbeitet Prompts und Antworten des jeweiligen LLM-Aufrufs (Chat, Vision, Embeddings), Audio-Payloads für Speech-to-Text und den Texteingang für Text-to-Speech sowie Bild-Prompts und generierte Bilder. Die Daten gehen über das In-Region-Routing von OpenRouter (`eu.openrouter.ai`) und werden auf Tales Seite nicht als separate Kopie gespeichert.
