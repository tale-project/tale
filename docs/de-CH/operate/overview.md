...
- KI-Chat-Assistent mit mehrstufigen Konversationen, Datei-Anhängen, Agent-Auswahl, [Arena Mode](/de-CH/use/chat/arena-mode) zum Modellvergleich, [Canvas](/de-CH/use/workspace/canvas) zur Inhaltsbearbeitung und eingebauten Tools.
- [Prompt Library](/de-CH/use/workspace/prompt-library) zum Speichern und Teilen wiederverwendbarer Prompt-Vorlagen.
- Semantische Wissensdatenbank für Dokumente, Websites, Products, Customers und Vendors mit [Dokumenten-Vergleich](/de-CH/use/workspace/document-comparison).
