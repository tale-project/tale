...
- **Security**: alles, was Authentifizierung, Session, Secret-Speicherung, Crypto oder erreichbare Abhängigkeits-CVEs berührt. Im Zweifel als Security klassifizieren UND ein [Security Advisory](/de-CH/operate/security/advisories) anlegen.
...
- [Security-Advisory-Prozess](/de-CH/operate/security/advisories) — wann zusätzlich ein GitHub Security Advisory erstellt wird.
