...
Prüfe deinen Provider-API-Schlüssel unter Einstellungen > Providers. Typische Ursachen:

- Abgelaufener oder widerrufener API-Schlüssel. Regeneriere ihn auf openrouter.ai und aktualisiere ihn unter Einstellungen > Providers.
- Zu wenig Guthaben auf deinem OpenRouter-Konto.
- Das im Provider-File konfigurierte Modell ist auf deinem Tier nicht verfügbar.
...
Siehe [Contributing Docker guide](/de-CH/develop/contributing-docker) für Techniken zur Image-Reduktion.
