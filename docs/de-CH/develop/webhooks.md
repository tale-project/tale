...
Tale bietet zwei Arten von Webhooks: **Workflow-Webhooks** (lösen eine Automatisierung aus) und **Agent-Webhooks** (senden eine Nachricht an einen Agent ausserhalb der Chat-UI). Beide nutzen dasselbe Request-Format und dasselbe Signatur-Schema.
...
- [API-Referenz](/de-CH/develop/api-reference) für die vollständige REST-API.
- [Trigger](/de-CH/build/automations/triggers) für die Konfiguration von Webhook-Triggern an Workflows.
- [Agents — Webhook-Tab](/de-CH/build/agents/create#tab-webhook) für die Agent-Webhook-Einrichtung.
