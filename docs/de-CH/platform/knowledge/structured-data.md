...
Der Bereich **Kunden** speichert deine Kundenliste. Jeder Kunde hat eine E-Mail-Adresse, ein Locale, einen Status und optionale benutzerdefinierte Metadaten. Importierte Kunden haben standardmässig den Status `churned`.
