...
- **Maximale Dateigrösse:** 100 MB pro Datei (Standard). Admins können pro MIME-Typ eine strengere Grenze setzen (z. B. 25 MB für Audio) in der [Upload-Richtlinie](/de/platform/admin/governance#upload-policy).
