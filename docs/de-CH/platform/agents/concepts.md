...
Wissen ist die Teilmenge der [Wissensdatenbank](/de/platform/workspace/knowledge-base), die der Agent durchsuchen darf. Standardmässig dürfen Agents alles durchsuchen, was die Organisation hochgeladen hat. Du kannst das nach Ordner, Team oder Entitätstyp (Dokumente, Produkte, Kunden, Lieferanten) einschränken.
