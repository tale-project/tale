...
| **Budgets und Model Access** | Governance-Richtlinien (siehe [Governance](/de-CH/admin/governance)) lassen sich pro Team scopen.                                                                 |
...
Wenn SSO oder Trusted Headers genutzt werden, ist der externe IdP die einzige Quelle der Wahrheit für Teams. Tale liest bei jedem Login den Teams-Header und aktualisiert die Teams-Liste des Nutzers. Siehe [Authentifizierung](/de-CH/admin/authentication).
