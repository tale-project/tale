...
The full per-locale convention table (quotes, apostrophes, dates, numbers, currency, NBSP, ß, dashes) lives in the companion [`write-translations`](../write-translations/SKILL.md) skill.
