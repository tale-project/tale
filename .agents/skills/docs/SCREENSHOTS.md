...
The broader docs contract lives in [SKILL.md](SKILL.md); the per-locale rules for translated alt text and callouts live in the companion [`translation`](../translation/SKILL.md) skill. Read those for voice and locale parity; read this file before you reach for a capture tool.
