...
[`.agents/skills/translation/locales/<locale>/AGENTS.md`](../translation/locales/) and rewrite to the
locale form.
...
- **DE / FR page leaves a translate-bucket English noun in prose.** Use the native term from [`.agents/skills/translation/BUCKETS.md`](../translation/BUCKETS.md).
