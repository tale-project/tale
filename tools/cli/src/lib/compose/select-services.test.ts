...
describe('selectDefaultServices', () => {
  test('always rolls platform + the always-roll tier (convex, sandbox-llm-gateway); sandbox flips separately', () => {
    ...
    expect(sel.stateful).toEqual(['convex', 'sandbox-llm-gateway']);
  });
