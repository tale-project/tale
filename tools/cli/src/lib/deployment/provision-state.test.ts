...
test('private intent is exclusive, bounded, durable and retains exact credentials on phase update', () =>
  fixture((root) => {
...
test('private state refuses symlinks, shared links, exposed permissions and unsafe names before writing', () =>
  fixture((root) => {
...
test('native state admission refuses a missing data root or symlinked/exposed parents before creating deployment data', () =>
  fixture((root) => {
