...
export const Textarea = forwardRef<HTMLTextAreaElement, TextareaProps>(
  ({ className, rows = 4, ...props }, ref) => (
    <textarea
      ...
      rows={rows}
      className={cn(
        'min-h-[96px] w-full rounded-lg border border-[color:var(--color-border-base)] bg-[color:var(--color-bg-base)] px-3 py-2 text-base text-[color:var(--color-fg-base)] md:text-sm placeholder:text-[color:var(--color-fg-subtle)] shadow-sm transition-colors',
