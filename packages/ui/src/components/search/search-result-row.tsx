...
import { SkeletonBox, SkeletonText } from '../feedback/skeleton';
      ...
      >
        ...
        <span className="min-w-0 flex-1">
          <span className="text-fg-base flex items-center gap-2 text-sm font-medium">
            <span className={cn('truncate', loading && 'w-1/3')}>
              {loading ? (
                <SkeletonText />
              ) : (
          ...
          {secondary ? (
            <span
              className={cn(
                'text-fg-muted mt-0.5 line-clamp-2 text-xs leading-relaxed',
                loading && 'w-3/4',
              )}
            >
              {loading ? (
          ...
          {breadcrumb.length > 0 ? (
            <span
              className={cn(
                'text-fg-subtle mt-1 flex min-w-0 items-center gap-1 truncate text-[10.5px]',
                loading && 'w-1/4',
              )}
