...
describe('htmlToMarkdown', () => {
  ...
  it('rewrites <a> with href as inline links', () => {
    const out = htmlToMarkdown(
  ...
  it('drops chrome elements (nav/header/footer/script/style/svg/button)', () => {
    const out = htmlToMarkdown(
      [
  ...
  it('drops aria-hidden and role-based chrome subtrees', () => {
    const out = htmlToMarkdown(
      [
  ...
  it('renders a description list as a bulleted "term: definition" list', () => {
    const out = htmlToMarkdown(
