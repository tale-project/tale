...
| F5  | Footer Platform + Company     | Footer **Platform** (`footer.platform`); **Company** (`footer.company`): About us + Contact us + Request a demo; address column under Platform                                                                            | Platform links commit the hub `/platform` (**Platform overview**, `nav.product.hub.label`) + the six `/platform/{module}` pages; company links commit `/about`, `/contact`, and `/request-demo`; address shows Ruler GmbH + VAT link                                                                                                                                                       |
