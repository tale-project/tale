...
(`/tmp/ui-docs-qa/r0001/`); the record here is the durable trace.
...
number (`R42`, `R42-SMOKE-6`); only the filename pads.
...
|---|---|---|---|---|
| [R1](r0001.md) | 2026-09-14 | All 19 guides, native chrome, live examples and responsive rendering | 4 bug | fixed + pinned |
...
1. **Copy the two templates.**
   ...
   `/tmp/ui-docs-qa/r<nnnn>/log.md` (tick there, never in a suite),
