...
export function platformTaskNatives(
  ...
  const get: NativeIntegrationImpl = async (
    input: unknown,
  ...
  const updateStatus: NativeIntegrationImpl = async (
    input: unknown,
    ctx: NativeIntegrationContext,
  ) => {
  ...
  const comment: NativeIntegrationImpl = async (
    input: unknown,
    ctx: NativeIntegrationContext,
  ) => {
  ...
  const listComments: NativeIntegrationImpl = async (
    input: unknown,
    ctx: NativeIntegrationContext,
  ) => {
