 ...
 * Node's ESM resolver demands fully-specified relative imports. Much of the
 * tree it runs (`services/platform/lib/**` and the ported domain logic under
 * `services/platform/backend/core/**`) was written for bundler resolution
 * and uses extensionless relative imports throughout. This hook teaches Node
 * the bundler convention: when a relative/absolute specifier fails to
 * resolve, retry `<specifier>.ts`, then `<specifier>/index.ts`.
 *
