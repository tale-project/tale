...
import { ValidationCheckItem, ValidationCheckList } from './validation-check-item';

const meta: Meta<typeof ValidationCheckItem> = {
  title: 'Feedback/ValidationCheckItem',
  component: ValidationCheckItem,
  tags: ['autodocs'],
  parameters: {
    layout: 'centered',
    docs: {
...
## Usage
\`\`\`tsx
import { ValidationCheckItem, ValidationCheckList } from '@/components/ui/feedback/validation-check-item';

<ValidationCheckItem isValid={true} message="At least 8 characters" />
...
export default meta;
type Story = StoryObj<typeof ValidationCheckItem>;
...
export const SingleItem: Story = {
  render: () => (
    <div className="space-y-2">
      <ValidationCheckItem isValid={true} message="Email verified" />
      <ValidationCheckItem isValid={false} message="Phone number required" />
      <ValidationCheckItem isValid={true} message="Two-factor enabled" />
    </div>
  ),
  parameters: {
    docs: {
      description: {
        story: 'Individual validation items without the list wrapper.',
      },
    },
  },
};
