...
const inputVariants = cva(
  'flex w-full rounded-lg focus:border border-input bg-background px-3 py-2 text-base ring-offset-background file:border-0 file:bg-transparent file:text-sm file:font-medium placeholder:text-muted-foreground focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:cursor-not-allowed disabled:opacity-50 ring-1 ring-border focus-visible:ring-primary border-border transition-[border-color,box-shadow] duration-150',
  {
    variants: {
      size: {
        default: 'h-9',
