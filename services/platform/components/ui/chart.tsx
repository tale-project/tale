...
import { createContext, forwardRef, useContext, useMemo, useId } from 'react';
import type {
  ComponentProps,
  ReactNode,
  ComponentType,
...
interface ChartTooltipContentProps extends Omit<ComponentProps<'div'>, 'content'> {
  active?: boolean;
  payload?: Array<{
    dataKey?: string;
    name?: string;
...
const ChartTooltipContent = forwardRef<HTMLDivElement, ChartTooltipContentProps>(
  (
    ...
    const tooltipLabel = useMemo(() => {
      ...
      if (labelFormatter) {
        return (
          <div className={cn('font-medium', labelClassName, 'bg-red-300')}>
