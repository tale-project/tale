// Unit gates for the session read helpers: the stale automation-run reaper's
// row selection and the owner-identity resolution the credential broker
// injects. Mocks the generated query factory so the handlers are callable.
