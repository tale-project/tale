...
export const agentAction: ActionDefinition<AgentActionParams> = {
  ...
  description:
    'Workforce operations on org agents: run_on_task / decompose_task (never throw — {ok, error, refusedReason} rides output.data for condition branches), check_run_budget, get_org_role, list_task_candidates, reassign_or_unassign. organizationId is read from workflow context variables.',
