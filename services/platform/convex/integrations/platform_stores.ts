...
import type { WorkflowDocumentStore } from '../../lib/integrations/natives/platform-documents';
import type { WorkflowTaskStore } from '../../lib/integrations/natives/platform-tasks';
