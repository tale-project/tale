/**
 * Signed capability tokens for the integrations HOST-CALL endpoint —
 ...
 * `/api/integrations/hostcall`, where the real live host (allowlist, https,
...
const KEY_DERIVATION_CONTEXT = 'integrations-hostcall:v1';
