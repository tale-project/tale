 ...
 * `bunx @better-auth/cli generate --output convex/betterAuth/generated_schema.ts -y`
 *
...
export const tables = {
  ...
  session: defineTable({
    ...
    trustedRole: v.optional(v.union(v.null(), v.string())),
    trustedTeams: v.optional(v.union(v.null(), v.string())),
  })
