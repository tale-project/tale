...
/**
 * Re-export of the shared file-based LLM provider-config reader.
 *
 * The canonical implementation lives in `@tale/shared/config/providers` — one source of
 ...
 */
export * from '@tale/shared/config/providers';
