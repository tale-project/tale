...
export const createPendingAuthorizationRef = makeFunctionReference<
  ...
  CreatePendingArgs,
  null
>('http_connectors/oauth_state_mutations:createPendingAuthorization');

export const consumePendingAuthorizationRef = makeFunctionReference<
  'mutation',
  StateHashArgs,
  ConsumePendingResult
>('http_connectors/oauth_state_mutations:consumePendingAuthorization');
...
>('http_connectors/connector_catalog:getOauth2Endpoints');
...
export const resolveTeamRouteRef = makeFunctionReference<
  ...
  { teamId: string },
  SlackTeamRoute | null
>('http_connectors/slack_routing:resolveTeamRoute');
...
>('http_connectors/slack_routing:claimTeamRoute');
...
export const deliverInboundEventRef = makeFunctionReference<
  ...
  null
>('http_connectors/slack_routing:deliverInboundEvent');
