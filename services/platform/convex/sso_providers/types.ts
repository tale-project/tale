...
export interface SsoProviderAdapter {
	...
	exchangeCodeForTokens(config: SsoProviderConfig, params: TokenExchangeParams): Promise<SsoTokens>;
	...
	mapToRole?(rules: RoleMappingRule[], defaultRole: PlatformRole, userInfo: SsoUserInfo): PlatformRole;
}
