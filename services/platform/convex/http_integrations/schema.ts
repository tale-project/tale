 ...
 */
export const integrationOauthStatesTable = defineTable({
  ...
  userId: v.string(),
  /** Connector directory name (`configs/platform/system/integrations/<slug>/`). */
...
export const slackTeamRoutesTable = defineTable({
  ...
  teamId: v.string(),
  /**
   * The `integrationCredentials` row holding this workspace's bot token. Kept
