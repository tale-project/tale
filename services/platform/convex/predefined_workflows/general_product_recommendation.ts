...
If tools are available, call them as needed to look up products or search the knowledge base before you produce the final JSON response.
`,
            },
            {
              name: 'llmUserPrompt',
  ...
  "recommendations": [
    {
      ...
      "imageUrl": "Image URL or empty string if unknown",
    ...
    },
    {
      ...
      config: {
        ...
        parameters: {
          ...
          tableName: 'customers',
          workflowId: '{{workflowId}}',
          documentId: '{{currentCustomerId}}',
          documentCreationTime: '{{currentCustomer._creationTime}}',
          metadata: {
