...
| --- | -------------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------- |
| F1  | Captions path        | In `/dashboard/{org}/chat`, paste a YouTube URL **with** captions into the composer.                                                                                               | A chip appears, progresses through reading states, and reaches **Ready**. Send a message asking about the video; the agent cites transcript content. |
