...
| F5  | DataTable page                | At 390 px, open `/dashboard/{org}/contacts`                                                                  | The page settles into either the **Add** menu button (`contacts.addButton`; its menu holds **Manual entry** / **From your device**, `contacts.importMenu.manualEntry` / `contacts.importMenu.fromDevice`) **or** the empty state **No contacts yet** (`emptyStates.contacts.title`) — both prove the table chrome rendered. No action is clipped off-screen. |
...
| F9  | ~~Workspace panel~~ (retired) | —                                                                                                            | The chat side panel / canvas strip was removed in #2857/#2877; no mobile canvas surface exists to test.                                                                                                                                                                                                                                                      |
