/**
 * Episode 7 — "Integrations & the outside world", the in-depth guide. The
 ...
 * integration for the seeded state). The connect scene is check-then-act:
...
export const EP7_INTEGRATIONS: EpisodeSpec = {
  ...
  scenes: [
    ...
    },
    {
      ...
      minMs: 20_000,
      narration: {
        en: 'First, where connectors come from. We switch to All integrations… and this is the catalog: Gmail, Slack, Shopify — ready-made, one connection each, shared by the whole workspace. And here’s GitHub. Before we connect it, let’s read what it’s actually allowed to do.',
        de: 'Zuerst: Woher kommen Connectoren? Wir wechseln auf Alle Integrationen … das ist der Katalog: Gmail, Slack, Shopify — fertig gebaut, eine Verbindung pro Dienst, geteilt vom ganzen Arbeitsbereich. Und hier: GitHub. Bevor wir verbinden, lesen wir nach, was er überhaupt darf.',
    ...
    },
    {
      ...
      minMs: 21_000,
      narration: {
        en: 'Back to integrations, one last time. The Connected tab — and there’s the row we came for: GitHub, next to Tavily, available to every agent and automation in this workspace. Anyone on the team can open this page and see exactly what the workspace can reach.',
        de: 'Zurück zu den Integrationen, ein letztes Mal. Der Tab Verbunden — und da ist die Zeile, für die wir gekommen sind: GitHub, neben Tavily, verfügbar für jeden Agenten und jede Automatisierung im Arbeitsbereich. Jeder im Team kann diese Seite öffnen und sehen, was der Arbeitsbereich erreichen kann.',
    ...
    },
    {
      ...
      minMs: 22_000,
      narration: {
        en: 'And that’s the episode. You read a connector’s operations and hosts before trusting it, connected GitHub with a token that was checked on the spot, found it under Connected, staged an MCP server without saving a fake one, and read the package policy. The integrations section of the docs goes deeper on each.',
        de: 'Und das war die Episode. Du hast Operationen und Hosts eines Connectors gelesen, bevor du ihm vertraust, GitHub mit einem sofort geprüften Token verbunden, es unter Verbunden wiedergefunden, einen MCP-Server angelegt, ohne einen ausgedachten zu speichern — und die Paketrichtlinie gelesen. Die Doku zu Integrationen vertieft jedes Thema.',
