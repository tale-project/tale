...
/**
 * "Metrics" settings section — one org-level home for usage, feedback,
 * automations, workforce, and project KPIs. The unified settings rail owns
