    ...
    return (
      <div className="grid place-items-center flex-[1_1_0] ring-1 ring-border rounded-xl p-4">
        <div className="text-center max-w-[24rem] flex flex-col items-center">
          <Users className="size-6 text-secondary mb-5" />
          <div className="text-lg font-semibold leading-tight mb-2">
            No customers yet
          </div>
          <p className="text-sm text-muted-foreground mb-5">
            Upload your first customer to get started
          </p>
        ...
        <Table>
          <TableHeader>
            <TableRow className="bg-secondary/20">
              <TableHead className="w-[17.375rem] font-medium text-sm">
                Name
              </TableHead>
              ...
              <TableHead className="w-[8.75rem] text-right font-medium text-sm">
          ...
          <TableBody>
            {customers.map((customer, index) => (
              ...
              >
                <TableCell className="w-[17.375rem]">
                ...
                <TableCell className="w-[8.75rem] text-xs text-muted-foreground">
                  {customer.source
                    ? startCase(customer.source.toLowerCase())
                    : 'Unknown'}
                </TableCell>
