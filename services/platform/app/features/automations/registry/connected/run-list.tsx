...
export function RunList({ title, workflowSlug }: RunListProps) {
  ...
  const { organizationId, projectId, automationSlug } = useAutomationRuntime();
                ...
                <TableRow key={id || i}>
                  ...
                  <TableCell>
                    <IconButton
                      ...
                      disabled={!id}
                      onClick={() =>
                        // A project-scoped automation watches runs under its project
                        // route (keeping the project shell + tab); org automations use
