...
interface WorkflowLoopContainerProps {
  data: {
    label: string;
    stepSlug: string;
...
export function WorkflowLoopContainer({ data }: WorkflowLoopContainerProps) {
  ...
  return (
    <div className="relative h-full w-full">
      ...
      {/* Main Card - matches regular workflow step styling */}
      <button
        type="button"
        aria-label={
          data.label
