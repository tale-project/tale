...
describe('useFileUpload — per-type size ceiling (#2048)', () => {
...
// ---------------------------------------------------------------------------
describe('useFileUpload — in-flight slot cap (#2026)', () => {
...
// ---------------------------------------------------------------------------
describe('useFileUpload — slot-overflow vs total-size ordering (#2029)', () => {
...
// ---------------------------------------------------------------------------
describe('useFileUpload — total-size check uses compressed sizes (#2031)', () => {
  beforeEach(() => {
