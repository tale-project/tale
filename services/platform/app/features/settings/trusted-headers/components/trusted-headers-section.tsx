    ...
    >
      ...
      >
        {createdKey === null ? (
          ...
          // Labelled with the header the proxy sends the key in, so the
          // person leaves with "header: value", not a bare secret to look up
          // a header name for.
          <CopyableField
            ...
            mono
            copyAriaLabel={t('enterpriseSso.copy')}
            description={`${t('enterpriseSso.trustedHeaders.keyCreatedHelp')} ${t('enterpriseSso.trustedHeaders.keyCreatedSendAs')}`}
          />
        )}
      </FormDialog>
