...
/**
 * Read the deployment-level config + masked secret presence + the
 * `uiEnabled` flag. Deployment-scoped (no org arg). Gated server-side on
 * instance-admin; `uiEnabled` drives edit-vs-read-only in the UI.
 *
