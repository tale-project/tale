...
import { useApiKeysTableConfig } from './use-api-keys-table-config';
...
describe('useApiKeysTableConfig', () => {
  // Regression for #2381: the API-keys table renders under `SettingsPage`
