...
>(function SelectTriggerButton({ hasValue, children, ...props }, ref) {
  return (
    <button
      ...
      type="button"
      {...props}
      className="ring-border bg-input flex h-8 w-full items-center justify-between rounded-md px-3 text-sm ring-1 disabled:cursor-not-allowed disabled:opacity-50"
    >
