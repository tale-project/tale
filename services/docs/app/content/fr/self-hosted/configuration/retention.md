...
- **Interface de gouvernance** — surcharges par organisation dans la limite environnement. Voir [Gouvernance](/fr/platform/admin/governance).
...
- [Référence d’environnement](/fr/self-hosted/configuration/environment-reference) — liste complète des variables d’environnement Tale.
- [Gouvernance](/fr/platform/admin/governance) — surcharges de rétention par organisation et legal hold.
