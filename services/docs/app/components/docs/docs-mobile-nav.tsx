...
interface DocsMobileNavProps {
  ...
  /** Slug of the active page; used for highlighting inside the drawer. */
  activeSlug: string;
...
export function DocsMobileNav({
  ...
  const home = docPath(locale, 'index');
  ...
  // closes — a keyboard reader would land on `<body>`. Put them back on the
