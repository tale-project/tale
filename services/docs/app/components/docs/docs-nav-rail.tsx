 ...
 * at the same `h-13` as the article header's breadcrumb row, so the two
 * bottom borders meet as a single line across the viewport. Hidden below
 * `md`, where the same tree is reached through the drawer.
 */
