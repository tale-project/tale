...
// replica created the session, or this spawner restarted) the route layer
// re-resolves from the backend by deterministic name. Per-exec AbortControllers
// live here too, keyed sessionId/execId, so cancel can find them.
