...
// `packages` layers the shared component library's message bundle
// under this service's own keys. Drop it if this service renders no
// `@tale/ui` component that needs translated strings.
