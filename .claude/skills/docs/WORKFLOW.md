...
When a test fails, the fix-priority order — and what every check catches — is the
[`docs-check`](../docs-check/SKILL.md) skill. For a terminology or formal-pronoun failure, read the
per-locale doctrine at
[`.claude/skills/translation/locales/<locale>/AGENTS.md`](../translation/locales/) and rewrite to the
locale form.
...
- **DE / FR page leaves a translate-bucket English noun in prose.** Use the native term from [`.claude/skills/translation/BUCKETS.md`](../translation/BUCKETS.md).
