...
> **Implementation.** This document is the design _intent_; the design system that actually ships is
...
| Screen                                                        | ID      | Theme | Description                                                                                                                                                                                                                                                                                                                                                                                          |
| ------------------------------------------------------------- | ------- | ----- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| Conversations - Setup                                         | `xMyM9` | Light | Setup/onboarding state — full-page centered "Activate conversations" + "Connect your email..." + Connect email button. Shown before email connector is connected. (1280x720)                                                                                                                                                                                                                         |
