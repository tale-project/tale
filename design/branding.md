...
- [`designs/shared/branding.pen`](../designs/shared/) — brand identity, logo usage, colour usage.
- [`designs/shared/logofolio.pen`](../designs/shared/) — the logo system and variations.
- [`designs/shared/images/`](../designs/shared/images/) — the department / agent logos (`logo-design`,
