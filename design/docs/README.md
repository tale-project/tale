...
> exported images, the generated app handoff [`design-system.md`](../sources/platform/design-system.md),
> the token export [`semantic-tokens.json`](../sources/platform/semantic-tokens.json), and the
> [`accessibility-audit.md`](../sources/accessibility-audit.md). These docs distil and point to that
> source; they never fork it. Designer↔developer UI notes go in `design/docs/comments.md` (per
...
- [`design/sources/platform/design-system.md`](../sources/platform/design-system.md) — the app design _intent_
  - component/screen specs (1815 lines; the deep app reference).
- [`design/sources/platform/semantic-tokens.json`](../sources/platform/semantic-tokens.json) — the
...
- The `.pen` files are **encrypted** — open them only through the Pencil MCP with the editor running
  ...
  [`design/sources/platform/images/`](../sources/platform/images/) + the spec in `design-system.md`.
...
- **Accessibility is WCAG 2.1 AA** — the form text hierarchy (label → description → hint → error) and
  ...
  [`design/sources/accessibility-audit.md`](../sources/accessibility-audit.md).
