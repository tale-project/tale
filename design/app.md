...
screen specs live in [`designs/platform/design-system.md`](../designs/platform/design-system.md) — go
there for the detail of any element below, and to a `.pen` file (via Pencil) or
[`designs/platform/images/`](../designs/platform/images/) for the pixels.
...
- **Auth, settings, automations, agents, onboarding** — each has a `.pen` under `designs/platform/`.
...
[`designs/accessibility-audit.md`](../designs/accessibility-audit.md): icon-only buttons need a real
